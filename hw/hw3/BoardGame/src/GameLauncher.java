 ...
 * It contains a method to display the game menu (TicTacToe and OrderAndChaos and Quoridor).
        ...
        while (true) {
            ...
            switch (gameChoice) {
                ...
                case '3':
                    ...
                    break;
                default:
                    System.out.println("Oops! That was not on the menu, try again!");
                    break;
            }
        }
