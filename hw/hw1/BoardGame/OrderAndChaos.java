...
public class OrderAndChaos extends TicTacToe {
    ...
    public void startGame(){
        ...
        players[0] = new Player("Order", 'O');
        players[1] = new Player("Chaos", 'O');
        ...
        while (true) {
            ...
            while (true) {
                ...
                if ((symbol == 'X' || symbol == 'O')) {
                    players[currentPlayerIndex].setSymbol(symbol);
                    break;
                } else {
            ...
            while (true) {
                ...
                try {
                    ...
                    if (!board.isValidMove(row, col) || move.length() != 3 || move.charAt(1) != ' ') {
