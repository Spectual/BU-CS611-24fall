...
public class Printer {
    ...
    public static void printValorWelcome(){
        println("\n======== GAME START ========");
        println("Welcome to Legends of Valor!");
        printEmptyLine();
        println("\033[34mGame Background\033[0m:");
        ...
        printEmptyLine();
        println("\033[32mGameplay\033[0m:");
        println("- World: The world is divided into a grids in three lanes, each with its own unique features like plain");
        println("  areas ('empty grid'), bush('B'), cave('C'), koulou('K') and inaccessible space('X'). Heroes can move around the world");
        println("  to explore, fight monsters,");
        println("- Battles with Monsters: Monsters keep moving down until a hero appear in its attack range. Monsters will attack");
        println("  heroes automatically. Heroes can attack monsters in their attack range to stop them from moving down.");
        println("  During a battle, hero can choose an action, such as attacking using a weapon, casting a spell, a potion, or equipping armor.");
        ...
        println("- Market: In Nexus spaces, heroes can enter a market and use their gold to buy weapons, armor, potions, and spells to");
        ...
        println("- Goal: Your goal is to have one of your heroes reach the Nexus of the monster team");
        println("  Good luck, adventurer! May your heroes grow strong, conquer every challenge, and become legends");
        printEmptyLine();
        println("\033[33mControls\033[0m:");
        ...
        println("- Market Access: When on a Nexus space, press 'm' to enter the market to buy or sell items and manage your heroes' inventories.");
    ...
    public static void printMahWelcome(){
        println("\n======== GAME START ========");
        ...
        println("- Battle Commands: During battle, each hero can choose to attack, cast spells, use potions, or equip weapon or armor.");
        println("  At any time, you can check the stats of your heroes or the monsters they face.");
        println("- Market Access: When on a market space, press 'h' to enter the market to buy or sell items and manage your heroes' inventories.");
        println("- Exit Game: Press Q at any time to quit the game.");
        println("- Again! Press H at any time if you lose sight of what to do.");
        printEmptyLine();
        println("Good luck, adventurer! May your heroes grow strong, conquer every challenge, and become legends");
    ...
    public static void displayMahHelp(){
        println("\nCommands:");
        println("w/W - Move up");
    ...
    public static void displayHelp(){
        ...
        println("s/S - Move down");
        println("d/D - Move right");
        println("t/T - Teleport to another hero");
        println("r/R - Recall to Nexus");
        println("k/K - Start to attack ");
        println("up/UP - Use potion");
        println("ew/EW - Equip weapon");
        println("ea/EA - Equip armor");
        println("p/P - Pass the turn");
        println("b/B - Open inventory");
        println("m/M - Open market");
        println("v/V - View map");
        println("i/I - Display character information");
        println("h/H - Display command help");
        println("q/Q - Quit the game");
        printEmptyLine();
    }
    ...
    public static void displayAllHeroes(Hero[] heroes) {
        println("\n============ \033[33mHERO\033[0m INFORMATION ============");
        
        String header = String.format("%-7s %-20s %-10s %-10s %-15s %-10s %-10s %-10s %-10s %-10s %-10s %-20s %-20s", 
            "Index", "Name", "Type", "Level", "Experience", "HP", "MP", "Strength", "Agility", 
            "Dexterity", "Gold", "Equipped Weapon", "Equipped Armor");
        println(header);

        for (int i = 1; i <= heroes.length; i++) {
            print(String.format("%-8d", i));
            println(heroes[i-1]);
        }
    ...
    public static void displayInfo(Hero[] heroes) {
        ...
        for (Hero hero : heroes) {
            print(String.format("%-8d", hero.getIndex()));
            println(hero);
        }
    ...
    public static void displayInfo(Hero[] heroes, Monster[] monsters){
        displayInfo(heroes);
        println("\n============ \033[35mMONSTER\033[0m INFORMATION ============");

        String header = String.format("%-7s %-20s %-15s %-10s %-10s %-10s %-10s %-10s",
        "Index", "Name", "Type", "Level", "HP", "Damage", "Defense", "Dodge");
        println(header);

        for (Monster monster : monsters) {
            print(String.format("%-8d", monster.getIndex()));
            println(monster);
        }
        println("=============================================");
    }
    ...
    public static void printWarning(String message){
        println("\033[33m[WARNING]\033[0m] " + message);
    }

    public static void printTip(String message){
        println("\033[33m[TIP]\033[0m " + message);
    }
    ...
    public static String getHeroColorName(Creature hero){
        return "\033[33m[" + hero.getIndex() + "] " + hero.getName() + "\033[0m";
    }

    public static String getMonsterColorName(Creature monster){
        return "\033[35m[" + monster.getIndex() + "] " + monster.getName() + "\033[0m";
    }
}
